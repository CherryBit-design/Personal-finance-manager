  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (data.success === true) {
            ...
            // Navigate to the setAvatar page after successful registration
            navigate("/setAvatar");
        } else {
        ...
        <Col md={{ span: 6, offset: 3 }}>
          ...
          <Form>
            ...
            <div style={{width: "100%", display: "flex" , alignItems:"center", justifyContent:"center", flexDirection: "column"}} className="mt-4">
              ...
              <p className="mt-3" style={{color: "green"}}>Already have an account? <Link to="/login" className="text-white lnk" >Login</Link></p>
            </div>
          </Form>
        </Col>
      </Row>
